...
.data 
  ...
  periIs: 	.asciiz "Rectangle's perimeter is "
  newline:	.asciiz "\n"
...
main:
  ...
  syscall           			# print the string
  				...
  				# Calculate perimeter
  add $8, $8, $8					# sum of width + width
  add $9, $9, $9					# sum of length + length
  add $11, $8, $9					# sum of 2*length + 2*width

				# Print "Rectangle's perimeter is "
  addi 	$v0, $0, 4  				# system call 4 is for printing a string
  la 	$a0, periIs 			# address of areaIs string is in $a0
  syscall           				# print the string
